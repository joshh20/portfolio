        ...
        <header className="bg-slate-50 text-slate-500 dark:bg-slate-900 dark:text-slate-400">
            <div className="mx-4 sm:mx-12">
                <div className="mx-auto flex max-w-4xl items-center justify-between py-5">
                    ...
                    {/* Right side */}
                    <div className="rounded-full border-2 border-gray-300 bg-transparent ring-gray-300 transition-all hover:ring-2 hover:ring-offset-2 dark:border-gray-700 dark:bg-transparent dark:ring-gray-200 dark:hover:ring-2 dark:hover:ring-offset-2">
                        <ThemeSwitch />
                    </div>
                </div>
            </div>
